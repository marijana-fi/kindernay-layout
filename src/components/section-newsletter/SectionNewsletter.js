    ...
    <section id="section-newsletter">
      ...
      <picture>
        <source
          ...
          srcSet="/kindernay-layout/img/bottom-newsletter-mobile.jpg"
        />
        <source
          media="(min-width: 600px)"
          srcSet="/kindernay-layout/img/bottom-newsletter-bg.jpg"
        />
        <img src="/kindernay-layout/img/bottom-newsletter-bg.jpg" alt="" />
      </picture>
    </section>
  );
}
